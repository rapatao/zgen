...
Clone the zgen repository
    ...
    git clone https://github.com/rapatao/zgen.git "${HOME}/.zgen"
...
By default, the initialization script will not be compiled after the creation, you can enable the compilation by enabling `$ZGEN_COMPILE_INIT`.
